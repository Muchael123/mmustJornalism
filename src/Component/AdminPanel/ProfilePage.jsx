  ...
  return (
    <>
      <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:w-fit md:px-24 lg:px-20 lg:py-12 p-8 rounded shadow-xl sm:p-16">
        <div>
          <h3 className="text-xl font-bold text-gray-500 border-b pb-4 mt-0">
            Account Information
          </h3>
          <div className="mt-4 py-3 ">
            ...
            <div className="flex items-center gap-4">
              <img
                className="w-[100px] h-[100px] object-cover object-center rounded-full p-2 "
                src="/src/images/testpic.jpg"
                alt=""
                width="384"
                height="512"
              />
        ...
        <div className="text-xl gap-4 grid mt-5 grid-cols-2">
          <div className="">
            ...
            <div className="relative mt-2 rounded-md shadow-sm">
              <div className="pointer-events-none absolut inset-y-0 left-0 flex items-start "></div>
              <input
                type="text"
                name="Name"
                id="Fname"
          ...
          <div className="">
            ...
            <div className="relative mt-2 rounded-md shadow-sm">
              <div className="pointer-events-none absolute inset-y-0 left-0 flex items-start "></div>
              <input
                type="text"
                name="Name"
                id="Lname"
