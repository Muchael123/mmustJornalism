      ...
      <div className="lg:pr-1">
        <div className="w-full">
          ...
          <div className="pl-2  pr-6">
            <img
              className="w-[80%] max-w-none rounded-md bg-gray-900 object-cover shadow-xl ring-1 ring-gray-400/10 sm:w-[57rem] mb-10"
              src={image}
              alt="News image"
            />
          </div>
          ...
          <div className="lg:row-start-2 lg:mx-auto lg:w-full lg:max-w-7xl lg:gap-x-8 lg:px-8">
            <div className="lg:pr-4">
              <div className="text-base leading-7 text-gray-700">{body}</div>
            </div>
          </div>
        </div>
